...
<div style="font-size: 25px;"><strong><span style="padding-right: 10px; padding-left: 700px; "><?php echo e($getTerm); ?></span><?php echo e($getYear); ?></strong></div>
 <br><br><br><br>
       ...
       <!-- Text input-->
        <div style="margin-left: 200px;" class="form-group<?php echo e($errors->has('sample_file') ? ' has-error' : ''); ?>">
            <div style="margin-right: 200px;">
                      ...
                      <?php /*   <?php echo Form::file('sample_file', array('class' => 'form-control','id'=>'excelfile')); ?> */ ?>
                        ...
                        <?php echo Form::file('sample_file', array('class' => 'inputForm' ,"style"=>"font-size:18px; padding-left:20px; width:400px;",'placeholder'=>'Enter Subject', 'id'=>'excelfile')); ?>
