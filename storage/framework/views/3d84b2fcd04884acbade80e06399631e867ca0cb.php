...
<div class="container spark-screen">
    ...
    <?php echo Form::open(array('route' => 'teachersetup.store', 'class'=>'form-horizontal', 'role'=>'form', 'files'=>'true')); ?>
...
<!-- include the partial    -->
       <?php echo $__env->make('Setupteachers/_crud', array('rwstate' => 'false') , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
       ...
       <div class="form-group">
         ...
         <div class="col-md-8">
         <input type="button" id="addteachersetup"  value="Add"  class="btn btn-primary">
           <input type="button" value="Delete Row"  class="btn btn-info delete-row">
           <input type="submit" id="save" value="Save" class="btn btn-success createteachersetup">
