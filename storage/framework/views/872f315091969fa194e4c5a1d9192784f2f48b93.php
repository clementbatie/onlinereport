...
<div class="container spark-screen">
    <div class="row">
        ...
        <div class="col-md-12 ">
          <div>
	       		<strong style="padding-left: 310px; font-size: 50px; position: fixed;" class="blinking">Terminal Scores Admin</strong>
	       	</div><br><br><br>
			...
			<?php endif; ?>
				...
				<div class="row">
					...
					<?php /* <div class="col-md-7">
						<?php echo e(-- <div style="background-color:#313b3d; padding-top: 10px; padding-bottom: 10px;"> */ ?>
						<?php /* <a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="{{route('terminalscore.create')); ?>" >Add New Terminal Score</a> */ ?>
            ...
            <tr>
	            ...
	            <div class="panel panel-primary">
                   ...
                   <p>
							...
							<tr>
						<?php /* 		
                        <td><input type="checkbox" name="categories10[]" class="checkboxes" value="<?php echo e($row->TerminanlScoreID); ?>" /></td> */ ?>
