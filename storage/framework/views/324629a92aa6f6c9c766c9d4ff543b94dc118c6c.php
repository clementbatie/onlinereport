			...
			<?php /* <p>
				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="<?php echo e(route('schoollogo.create')); ?>" >Add New Admin</a>
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="<?php echo e(route('schoollogo.index')); ?>" role="button">Refresh</a>
						<!-- <a class="btn btn-info" href="<?php echo e(url('parents')); ?>" role="button">Transfer</a> -->
						<a href="<?php echo e(url('/schoolinfo')); ?>" class="btn btn-primary">Return</a>
					</div>
					...
					<div class="col-md-4">
						<?php echo Form::open(array('method' => 'GET','route' => 'schoollogo.search')); ?>  
	            ...
	            <div class="panel panel-primary">
	               <?php /*  <div style="background-color:#00663d; color:#fff; padding-top: 12px;padding-bottom: 12px;padding-left: 20px;"  class="panel-primary2">List of Users</div> */ ?>
	                ...
	                <div class="panel-body">
	                 ...
	                 <p>
                           <div class="col-sm-12"> 
		                    <?php /*  <td> <button class="btn btn-danger">Delete Checked</button></td> */ ?>
		                   </div> 
		             </p>
							<tr>
								<th>#</th>
								<?php /* <td class="col-md-1" style="font-size: 10px;"><label><input type="checkbox" id="selectAll" name=""/> Select all</label></td> */ ?>
								<th>Name of School</th>					
								<?php /* <th>Address</th> */ ?>
								<?php /* <th>Contact Nos</th> */ ?>
								<th>School Code</th>
								<?php /* <th>Report Name</th> */ ?>
							...
							<tr>
								...
								<?php /* td><input type="checkbox" name="categories14[]" class="checkboxes" value="<?php echo e($row->id); ?>" /></td> */ ?>

								<td><?php echo e(isset($row->Name) ? $row->Name : 'DEFAULT'); ?></td>
                                <?php /* <td><?php echo e(isset($row->Address) ? $row->Address : 'DEFAULT'); ?></td> */ ?>
                                <?php /* <td><?php echo e(isset($row->ContactNos) ? $row->ContactNos : 'DEFAULT'); ?></td> */ ?>
                                <td><?php echo e(isset($row->SchoolCode) ? $row->SchoolCode : 'DEFAULT'); ?></td>
                               <?php /*  <td><?php echo e(isset($row->reportname) ? $row->reportname : 'DEFAULT'); ?></td> */ ?>
                                <td><?php echo e(isset($row->Logo) ? $row->Logo : 'DEFAULT'); ?></td>
                                <td><?php echo e(isset($row->LogoOnReport) ? $row->LogoOnReport : 'DEFAULT'); ?></td>
                               
                               <!--  <td><?php echo e(isset($row->date) ? $row->date : 'DEFAULT'); ?></td> -->
								<?php /* <td><a class="btn btn-xs btn-success" href="<?php echo e(route('Usermanagement3.show', $row->id)); ?>">
		                         <i class="glyphicon glyphicon-eye-open"></i></a> </td>  */ ?> 
								<td> 
		                        
			                     <a href="<?php echo e(action('schoollogoController@edit', array($row->SchoolIfoID))); ?>"
			                            class="btn btn-info btn-xs">
			                            <i class="glyphicon glyphicon-pencil"></i>
			                        </a>
