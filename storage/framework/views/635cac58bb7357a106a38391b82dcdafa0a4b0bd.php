...
<!-- include the partial    -->
       <?php echo $__env->make('3CUser/_crud', array('rwstate' => 'false') , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
       ...
       <div class="form-group">
         ...
         <input type="button" id="add3Cuser"  value="Add"  class="btn btn-primary">
           ...
           <input type="submit" id="save" value="Save" class="btn btn-success create3Cuser">
