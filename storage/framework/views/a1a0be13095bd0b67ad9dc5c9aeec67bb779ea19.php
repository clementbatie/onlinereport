...
<div class="container spark-screen">
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
			...
			<?php endif; ?>
				<p>
					<a class="btn btn-primary" href="<?php echo e(route('term.create')); ?>" >Add new data</a>
					<a class="btn btn-default" href="<?php echo e(route('term.index')); ?>" role="button">Show All</a>
	            ...
	            <div class="panel panel-primary">
	                ...
	                <div class="panel-body">
	                  ...
	                  <table class="table table-striped">
							...
							<td><a class="btn btn-xs btn-success" href="<?php echo e(route('term.show',[$row->TermID])); ?>">
