...
<div class="container spark-screen">
    <div class="row">
     ...
     <?php echo e(Form::model($rows->toArray(), array('method' => 'PATCH', 'route' =>array('terminalscore.update', $rows->TerminanlScoreID), 'class'=>'form-horizontal', 'role'=>'form', 'files'=>'true'  ))); ?>
       ...
       <!-- include the partial    -->
       <?php echo $__env->make('Terminalscore/_crud', array('rwstate' => 'true') , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
       ...
       <div class="form-group">
         ...
         <div class="col-md-8">
           ...
           <a class="btn btn-info" href="<?php echo e(action('terminalscoreController@edit', array($rows->TerminanlScoreID))); ?>" role="button">Edit</a>
