			...
			<?php endif; ?>
				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="<?php echo e(route('teacher.create')); ?>" >Add New Class Info</a>
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="<?php echo e(route('teacher.index')); ?>" role="button">Refresh</a>
			            ...
			            <?php /* <?php echo Form::text('searchString', null, array('placeholder'=>'By Teacher Name')); ?> */ ?>
                         ...
                         <div class="col-md-7">
                            ...
                            <?php echo Form::select('searchString1',$teachername, null, ['class' => 'form-control selectpicker', "style"=>"background-color:#00663d; color:#fff;",'placeholder'=>'Select Teacher','data-live-search'=>'true' ]); ?>
...
<form action="<?php echo e(route('categories8.deleteMultiple')); ?>" method="post">
	                  	...
	                  	<p>
                           <div class="col-sm-2"> 
							...
							<tr>
								...
								<td><input type="checkbox" name="categories8[]" class="checkboxes" value="<?php echo e($row->SetupTeacherID); ?>" /></td>
                                <td><?php echo e(isset($row->TeacherSetupName) ? $row->TeacherSetupName : 'DEFAULT'); ?></td>
                             <?php /*    <td><?php echo e(isset($row->PhoneNo) ? $row->PhoneNo : 'DEFAULT'); ?></td> */ ?>
                                <td><?php echo e(isset($row->ClassName) ? $row->ClassName : 'DEFAULT'); ?></td>
                                <td><?php echo e(isset($row->SubjectName) ? $row->SubjectName : 'DEFAULT'); ?></td>
                              
                 
								<td><a class="btn btn-xs btn-success" href="<?php echo e(route('teacher.show',[$row->SetupTeacherID])); ?>">Show
