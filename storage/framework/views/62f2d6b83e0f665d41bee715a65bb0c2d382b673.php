        ...
        <div class="col-md-10 col-md-offset-1">
			...
			<div class="row">
					...
					<div class="col-md-8">
						...
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="<?php echo e(route('usermanagement2.create')); ?>" >Add New User</a>
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="<?php echo e(route('usermanagement2.index')); ?>" role="button">Refresh</a>
					...
					<div class="col-md-4">
			            ...
			            <?php echo Form::text('searchString', null, array('class' => 'inputForm',"style"=>" font-size:18px;",'placeholder'=>'Type User Name')); ?>
			...
			<?php if($rows->count()): ?>
             <form action="<?php echo e(route('categories3.deleteMultiple')); ?>" method="post">
	                 ...
	                 <p>
                           <div class="col-sm-1"> 
							...
							<tr>
								...
								<td><input type="checkbox" name="categories3[]" class="checkboxes" value="<?php echo e($row->id); ?>" /></td>
