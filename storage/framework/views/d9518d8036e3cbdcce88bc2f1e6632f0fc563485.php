...
<!-- Latest compiled and minified JavaScript -->
    ...
    <link href="<?php echo e(asset('ppdu/css___/style.css')); ?>" rel="stylesheet">
    ...
    <!-- <div class="navbar-header"> -->
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
       ...
       <div style="padding-right:90px;">
                  <a style="color:#000000;" class="navbar-brand" href="index.html">BaTech <span>Limited</span></a>
       </div>
    ...
    <?php endif; ?>
         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo e(url('/listsofclass')); ?>">Lists of Class</a></li>
