     ...
     <!--    <div class="form-group<?php echo e($errors->has('SchoolCode') ? ' has-error' : ''); ?>">
         ...
         <div class="col-md-6">
            <?php echo Form::select('Year',$Year, null, array('class' => 'form-control', 'placeholder'=>'Select Parent Name', 'id'=>'year','class'=>'selectpicker form-control', 'data-live-search'=>'true',
             ( $rwstate=='true' ?  'readonly'  :null )  )); ?>
        ...
        <div class="form-group<?php echo e($errors->has('Term') ? ' has-error' : ''); ?>">
         ...
         <div class="col-md-6">
            <?php echo Form::select('Term',$Term, null, array('class' => 'form-control', 'placeholder'=>'Select Parent Name', 'id'=>'term','class'=>'selectpicker form-control', 'data-live-search'=>'true',
             ( $rwstate=='true' ?  'readonly'  :null )  )); ?>
