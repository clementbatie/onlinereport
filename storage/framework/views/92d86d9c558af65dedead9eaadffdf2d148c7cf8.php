...
<div class="container spark-screen">
    ...
    <?php echo Form::open(array('route' => 'classes.store', 'class'=>'form-horizontal', 'role'=>'form', 'files'=>'true')); ?>
...
<!-- include the partial    -->
       <?php echo $__env->make('classes/_crude', array('rwstate' => 'false') , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
       ...
       <div class="form-group">
         ...
         <input type="button" id="addclasses2"  value="Add"  class="btn btn-primary">
          <input type="button" value="Delete Row"  class="btn btn-info delete-row">
           <input type="submit" id="save"  class="btn btn-success createclasses2">
