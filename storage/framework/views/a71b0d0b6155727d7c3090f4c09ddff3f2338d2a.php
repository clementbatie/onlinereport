...
<div class="table-responsive">
   ...
   <tr><td colspan="10" > Name: <span style="margin-left: 10px; margin-right:10px"><?php echo e(isset($searchStr) ? $searchStr : ""); ?></span><?php echo e(isset($teacherName) ? $teacherName : ""); ?></td></tr>
    <tr><td colspan="10" class="">Report Period: <span style="margin-left: 10px; margin-right:10px"><u><?php echo e(isset($from) ? $from : "0"); ?></u> </span>To <span style="margin-left: 10px; margin-right:10px"><u><?php echo e(isset($to) ? $to : "0"); ?></u></span></td></tr>
              ...
              <tr>
                ...
                <td class="text-left"><?php echo e($row->TeacherSetupName); ?></td>
                <td class="text-left"><?php echo e($row->PhoneNo); ?></td>
                <td class="text-left"><?php echo e($row->SubjectName); ?></td>
                <td class="text-left"><?php echo e($row->ClassName); ?></td>
              
<?php /* 
               <?php for($i; $i<count($array); $i++): ?>

                   <td class="text-left"><?php echo e($array[$i]); ?></td>
                   <?php break; ?>
