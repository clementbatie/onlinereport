...
<body id="app-layout">
  <div style="height: 40px; margin-top: 20px;" class="header">
   <?php /* <h2 class="navbar-fixed-top" style="background-color: #f2f2f2; margin-top: -5px;">SentaCode Gh <span> Ltd</span></h2> */ ?>
    
   <tr>

<td>
 
   <?php /* <nav class="navbar-fixed-top" style="background-color: #f2f2f2; font-size: 40px; height: 90px; padding-left: 20px; padding-top: 6px; padding-bottom: 20px;"><strong>SentaCode Technologies Ltd</strong><span style="padding-left: 500px; font-size: 20px;"><strong>Contact: 0274440223</strong></span>
  
   </nav> */ ?>

  <nav class="navbar-fixed-top" style="background-color: #f2f2f2; font-size: 40px; height: 90px; padding-left: 30px; padding-top: 5px;"><strong><img style="margin-top: -7px; border-radius: 50%; font-size: 40px; margin-right: 5px;" src="<?php echo e(asset('uploads/sentacodelogo.jpg')); ?>" alt="" height="65px" width="80px"><strong>SentaCode Technologies Ltd</strong></strong><span class="fa fa-mobile-phone" style="padding-left: 500px; font-size: 20px;"><strong>: 0274440223</strong></span></nav>
  <?php /* <a>
  <img style="margin-top: -7px; border-radius: 50%; margin-right: -20px;" src="<?php echo e(asset('uploads/').'/'.(Auth::user()->ImageType)); ?>" alt="" height="35px" width="40px">
</a> */ ?>
</td>
...
<div class="collapse navbar-collapse" id="myNavbar">
  ...
  <?php if(Auth::guest()): ?>
      ...
      <ul class="nav navbar-nav">
          <li style="font-size: 30px; margin-right: 70px;"><a class="fa fa-home" href="<?php echo e(url('/')); ?>"></a></li>

          <?php /* <li><a class="active" href="<?php echo e(url('/')); ?>"></a></li> */ ?>
        ...
        <?php endif; ?>
          ...
          <li class="dropdown">
            ...
            <?php if(auth()->user()->UserLevelID == 4): ?>    
             ...
             <?php /*  <li><a href="<?php echo e(url('/schoollogo')); ?>">Add School Logo</a></li> */ ?>
          
             <li><a href="<?php echo e(url('/schoolinfo')); ?>">Create School Details</a></li>
            <?php endif; ?>
    ...
    <?php endif; ?>
         ...
         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo e(url('/studentreport')); ?>">Recent Terminal Report</a></li>
             <li><a href="<?php echo e(url('/Previous')); ?>">Previous Terminal Report</a></li>
        <?php if(auth()->user()->UserLevelID == 4 || auth()->user()->UserLevelID == 1): ?>
...
<?php if(auth()->user()->UserLevelID == 4 || auth()->user()->UserLevelID == 1): ?>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
             <li><a href="<?php echo e(url('/')); ?>">Send SMS to Parents/Teachers</a></li>
           <?php /*  <li><a href="<?php echo e(url('/sms')); ?>">Send SMS to Parents/Teachers</a></li> */ ?>
       ...
       <?php if(Auth::guest()): ?> 
        <?php /* <li><a href="<?php echo e(url('/login')); ?>"  class="active_link"><span class=""></span> Login</a></li> */ ?>
             <li><a href="<?php echo e(url('/')); ?>">Home</a></li>
              <li><a href="javascript:void(0)" a href="<?php echo e(url('/terminalscore2')); ?>">About Us</a></li>
              <li><a href="javascript:void(0)" a href="<?php echo e(url('/studentbehaviour2')); ?>">Contact Us</a></li>
