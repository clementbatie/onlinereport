...
<div class="container spark-screen">
    ...
    <?php echo Form::open(array('route' => 'schoollogo.createSchoolLogo', 'class'=>'form-horizontal', 'role'=>'form', 'files'=>'true')); ?>
...
<!-- include the partial    -->
       <?php echo $__env->make('SchoolLogo/_crud', array('rwstate' => 'false') , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
