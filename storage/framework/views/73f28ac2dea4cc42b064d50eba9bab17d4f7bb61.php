      ...
      <br>
       <!-- Text input-->
      <?php /*  <div class="form-group<?php echo e($errors->has('  SubjectName') ? ' has-error' : ''); ?>">
         <?php echo Form::label('  SubjectName', 'Subject Name:' , array('class'=>'col-md-4 control-label'  )); ?>

         <div class="col-md-6">
            <?php echo Form::select('SubjectName',$subject, null, array('class' => 'form-control', 'placeholder'=>'Enter Subject Name', 'id'=>'subjectname','class'=>'selectpicker form-control', 'data-live-search'=>'true',
       ...
       <div class="form-group<?php echo e($errors->has('SubjectName') ? ' has-error' : ''); ?>">
         ...
         <div class="col-md-6">
            <?php echo Form::select('SubjectName',$subject, null, array('class' => 'form-control', 'placeholder'=>'Select Subject Name','id'=>'subjectname', 'class'=>'selectpicker form-control', 'data-live-search'=>'true',
             ( $rwstate=='true' ?  'readonly'  :null )  )); ?>
