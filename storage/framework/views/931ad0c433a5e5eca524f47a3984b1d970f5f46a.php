...
<div class="container spark-screen">
    <div class="row">
		...
		<?php /* <?php echo Form::open(array('method' => 'GET','route' => 'teachersetup.search')); ?>  
	 ...
	 */ ?>
        ...
        <div class="col-md-10 col-md-offset-1">
	        ...
	        <div>
	       		<strong style="padding-left: 300px; font-size: 50px; position: fixed;" class="blinking">Teachers</strong>
	       	</div><br><br><br>
			...
			<?php endif; ?>
				<?php /* <p>
					<a class="btn btn-primary" href="<?php echo e(route('teachersetup.create')); ?>" >Add new data</a>
					<a class="btn btn-default" href="<?php echo e(route('teachersetup.index')); ?>" role="button">Show All</a>
				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="<?php echo e(route('teachersetup.create')); ?>" >Add New Teacher</a>
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="<?php echo e(route('teachersetup.index')); ?>" role="button">Refresh</a>
						<!-- <a class="btn btn-info" href="<?php echo e(url('parents')); ?>" role="button">Transfer</a> -->
					</div>

					<?php /* <div class="col-md-4">
						<?php echo Form::open(array('method' => 'GET','route' => 'teachersetup.search')); ?>  
			           <?php echo e(--  <?php echo Form::label('searchString', 'Quick Search:'); ?> */ ?>
			            <?php /* <?php echo Form::text('searchString'); ?> */ ?>

			            <?php /* <?php echo Form::text('searchString', null, array('placeholder'=>'By Teacher Name')); ?>
					...
					<div class="col-md-4">
			            ...
			            <?php echo Form::text('searchString', null, array('class' => 'inputForm',"style"=>" font-size:18px;",'placeholder'=>'Type Teacher Name')); ?>
			...
			<?php if(count($rows)): ?>
	            ...
	            <form action="<?php echo e(route('categories6.deleteMultiple')); ?>" method="post">
	            ...
	            <div class="panel panel-primary">
	               <?php /*  <div style="background-color:#00663d; color:#fff; padding-top: 12px;padding-bottom: 12px;padding-left: 20px;"  class="panel-primary2">List of Teachers</div> */ ?>
	                  	...
	                  	<p>
                           <div class="col-sm-12"> 
							...
							<tr>
								...
								<td><input type="checkbox" name="categories6[]" class="checkboxes" value="<?php echo e($row->TeachersetupID); ?>" /></td>
                            <td><?php echo e(isset($row->TeacherSetupName) ? $row->TeacherSetupName : 'DEFAULT'); ?></td>
                               ...
                               <!--  <td><?php echo e(isset($row->ClassName) ? $row->ClassName : 'DEFAULT'); ?></td>
								...
								<td><a class="btn btn-xs btn-success" href="<?php echo e(route('teachersetup.show',[$row->TeachersetupID])); ?>">Show
		                                                  <?php /*  <i class="glyphicon glyphicon-eye-open"> */ ?></i></a> </td>   
								<td>
		                        
			                         <a href="<?php echo e(action('TeachersetupController@edit', array($row->TeachersetupID))); ?>"
			                    ...
			                    <td>
			                      ...
			                      <?php echo e(Form::open(array('method' 
			                    		=> 'delete', 'route' => array('teachersetup.destroy',$row->TeachersetupID)))); ?>  	                  
