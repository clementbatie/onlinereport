       ...
       <legend style="text-align: center; font-size: 50px;"> <strong>Create School Admin</strong></legend>
...
<div class="form-group<?php echo e($errors->has('SchoolCode') ? ' has-error' : ''); ?>">
 ...
 <div class="col-md-6">
  <?php echo Form::select('SchoolCode', $school ,null, array('class' => 'form-control','placeholder' => 'Select School Name', 'id'=>'SchoolCode',
  ( $rwstate=='true' ?  'readonly'  :null )  )); ?>
