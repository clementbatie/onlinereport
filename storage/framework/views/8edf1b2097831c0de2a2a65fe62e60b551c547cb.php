...
<div class="form-group<?php echo e($errors->has('ClassID') ? ' has-error' : ''); ?>">
 ...
 <div class="col-md-6">
  <?php echo Form::select('ClassID',$Class,null, array('class' => 'form-control', 'placeholder'=>'Select Class', 'id'=>'ClassofStudent',
  ( $rwstate=='true' ?  'readonly'  :null )  )); ?>
...
<div class="form-group<?php echo e($errors->has('id') ? ' has-error' : ''); ?>">
 ...
 <div class="col-md-6">
  <?php echo Form::select('id',$StudentName, null, array('class' => 'form-control', 'placeholder'=>'Select Student Name','id'=>'studentnameA',
  ( $rwstate=='true' ?  'readonly'  :null )  )); ?>
...
<?php /* <div class="form-group<?php echo e($errors->has(' PromotedTo ') ? ' has-error' : ''); ?>">
...
<div class="form-group<?php echo e($errors->has('AttendanceExpected') ? ' has-error' : ''); ?>">
 ...
 <div class="col-md-2">
  <?php echo Form::number('AttendanceExpected',null, array('class' => 'form-control', 'placeholder'=>'Expected', 'id' => 'AttendanceExpected',
  ( $rwstate=='true' ?  'readonly'  :null )  )); ?>
 ...
 <?php echo Form::label('ActualAttendance', 'Actual Attendance :' , array('class'=>'col-md-2 control-label'  )); ?>

 <div class="col-md-2">
  <?php echo Form::number('ActualAttendance',null, array('class' => 'form-control', 'placeholder'=>'Actual', 'id'=>'ActualAttendance',
  ( $rwstate=='true' ?  'readonly'  :null )  )); ?>
