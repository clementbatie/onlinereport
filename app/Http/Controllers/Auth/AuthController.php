...
class AuthController extends Controller
{
    ...
    */
    ...
    {
        //ff is out of place. should be put in the /register caller fxn.
    ...
    /** NNA fxn to change the defualt register load page. Neede to pass a list for  a drop down (userLevel)
    */
