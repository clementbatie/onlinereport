                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('UserLevelID') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                {!! Form::select('UserLevelID', $userLevelID, null, ['class' => 'form-control', 'placeholder'=>'Select a User Level'  ] ) !!}    
                        ...
                        <div class="form-group{{ $errors->has('PhoneNo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="PhoneNo" value="{{ old('PhoneNo') }}" , placeholder="024xxxxxxx" >
