...
<div class="form-group{{ $errors->has('DistrictID') ? ' has-error' : '' }}">
 ...
 <div class="col-md-6">
   ...
   'placeholder'=>'Select User District',($rwstate=='true' ? 'readonly' :null ) ] )!!}
...
<div class="form-group{{ $errors->has('AreaID') ? ' has-error' : '' }}">
 ...
 <div class="col-md-6">
   ...
   'placeholder'=>'Select User Section',($rwstate=='true' ? 'readonly' :null ) ] )!!}
...
<div class="form-group{{ $errors->has('UserLevelID') ? ' has-error' : '' }}">
  ...
  <div class="col-md-6">
    ...
    {!! Form::select('UserLevelID', $UserLevelID, null, ['class' => 'form-control', 
