  ...
  <div class="row"> 
    ...
    <div class="container" style="margin-top: 20px">
      ...
      <div class="col-md-4">
        <div class="card" style="height: 300px">
          <div class="card-heading">
            <div class="card-top-heading text-center">Background</div>
          </div>
          <div class="card-text">
      ...
      <div class="col-md-4">
        <div class="card" style="height: 300px">
          <div class="card-heading">
            <div class="card-top-heading text-center">Jetro Pricinple for Leaders</div>
          </div>
          <div class="card-text">
      ...
      <div class="col-md-4">
        <div class="card" >
          <div class="card-heading">
            <div class="card-top-heading text-center">Scripture</div>
          </div>
          <div class="card-text">
