...
<div class="col-md-4" style="margin-right: -910px;">
        <div style="padding-right: 100px;" class="form-group" >
         <img src="{{asset('uploads/p127.jpg')}}" alt="" class="img img-responsive studentimage" style="width: 100px; height: 120px;">
       </div>
...
<div class="form-group{{ $errors->has('Class') ? ' has-error' : '' }}">
 ...
 <div class="col-md-6">
  {!! Form::select('Class',$Class2,null, array('class' => 'form-control', 'placeholder'=>'Select Class', 'id'=>'Class',
  ( $rwstate=='true' ?  'readonly'  :null )  )) !!}
  @if ($errors->has('Class'))
  <span class="help-block">
