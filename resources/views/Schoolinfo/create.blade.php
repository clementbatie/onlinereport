...
<div class="container spark-screen">
    ...
    {!! Form::open(array('route' => 'schoolinfo.store', 'class'=>'form-horizontal', 'role'=>'form', 'files'=>'true')) !!}
...
<!-- include the partial    -->
       @include('Schoolinfo/_crud', array('rwstate' => 'false') )
       ...
       <div class="form-group">
         ...
         <div class="col-md-8">
         <input type="button" {{-- id="addschoolinfo" --}}  value="Add"  class="btn btn-primary">
          <input type="button" value="Delete Row"  class="btn btn-info delete-row">
           <input type="submit" id="save"  class="btn btn-success {{-- createschoolinfo --}}">
