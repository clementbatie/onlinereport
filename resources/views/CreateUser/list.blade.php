...
<div class="container spark-screen">
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
	        ...
	        <div>
	       		<strong style="padding-left: 370px; font-size: 50px; position: fixed;" class="blinking">Users</strong>
	       	</div><br><br><br>
			...
			<div class="row">
					...
					<div class="col-md-8">
						...
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="{{route('usermanagement2.create')}}" >Add New User</a>
						<a style="background-color:#00663d; color:#fff;" class="btn btn-primary" href="{{ route('usermanagement2.index') }}" role="button">Refresh</a>
					...
					<div class="col-md-4">
			            ...
			            {!! Form::text('searchString', null, array('class' => 'inputForm',"style"=>" font-size:18px;",'placeholder'=>'Type User Name')) !!}
			...
			@if ($rows->count())
             <form action="{{ route('categories3.deleteMultiple') }}" method="post">
                {{ csrf_field() }}
                <thead>
                    <tr>
                      <th style="width: 8px;">
	            <div class="panel panel-primary">
	                ...
	                <div class="panel-body">
	                 ...
	                 <p>
                           <div class="col-sm-1"> 
		                     <td class="col-sm-1"> <button class="btn btn-danger">Delete Checked</button></td>
		                   </div> 
		             </p>
							<tr>
								<th>#</th>
							...
							<tr>
								...
								<td><input type="checkbox" name="categories3[]" class="checkboxes" value="{{ $row->id }}" /></td>
                               ...
                               <!--  <td>{{$row->date or 'DEFAULT'}}</td> -->
								<td><a class="btn btn-xs btn-success" href="{{ route('usermanagement2.show', $row->id)  }}">
		                         <i class="glyphicon glyphicon-eye-open"></i></a> </td>   
								<td>
		                        
			                        <a href="{{ action('usermanagementController2@edit', array($row->id)) }}"
