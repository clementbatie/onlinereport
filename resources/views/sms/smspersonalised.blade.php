...
<div class="container spark-screen">
    ...
    <!-- <form class="form-horizontal" action="minute"  class="form-horizontal"> -->
       ...
       <fieldset>
<legend>Send Personalised SMS to Members</legend>
<?php $rwstate = 'false' ; ?>
<!-- include the partial    -->
 ...
 <div class="col-md-6">
  ...
  <div class="col-md-2">
      <p style="float:left; width:auto;">Chars: <span id="display_count" style=" color:red;">0</span></p>
        ...
        {!! Form::select('member', $membertypes, null, ['class' => 'form-control selectpicker','id'=>'membertypes', 'data-live-search'=>'true', 
    'placeholder'=>'Member Type' ,( $rwstate=='true' ?  'readonly'  :null )  ] ) !!}  
      </div>
         <div class="form-group">  
        {!! Form::select('gender', ["Male" => "Male","Female" => "Female"], null, ['class' => 'form-control selectpicker','id'=>'gender', 'data-live-search'=>'true', 
    'placeholder'=>'Gender' ,( $rwstate=='true' ?  'readonly'  :null )  ] ) !!}  
      </div>
        <div class="form-group">  
  ...
  <div class="col-md-6">
    ...
    'placeholder'=>'Member Name' ,( $rwstate=='true' ?  'readonly'  :null )  ] ) !!}    
    ...
    @endif
       ...
       <div class="form-group">
         ...
         <div class="col-md-8">
           ...
           <input type="submit" id="sendsmspersonalised"  class="btn btn-success sendsmspersonalised" value="Send Sms">
